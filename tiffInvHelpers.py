...
class Inventory:
    def __init__(self, gameDisplay, player:Player, pos:tuple, box_size:int ):
        self.rows = 4
        self.col = 8
    ...
    def createInventory(self, gameDisplay):
...
class itemOptionMenu:
    ...
    def createOptions(self, gameDisplay):
        #draw border box
...
class infoBox:
    ...
    def createInfo(self, gameDisplay):
        #draw border box
